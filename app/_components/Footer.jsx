...
const Footer = () => {
  return (
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
     ...
     <div>
        <h2 className='text-4xl text-primary font-bold'>Paras Hospital</h2>
     </div>
      </div>
  
      <p className="mx-auto  mt-6 max-w-md text-center leading-relaxed text-gray-500">
      Whether you're seeking routine check-ups or specialized care, we've got you covered. Our extensive network of healthcare professionals includes experts in various fields, ensuring that you find the perfect match for your needs
      </p>
